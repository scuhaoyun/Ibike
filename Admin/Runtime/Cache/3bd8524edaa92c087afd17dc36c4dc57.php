...
.searchbox {
	background:url(__IMAGE__/search_goods.png) no-repeat;
	width:350px;
	height:34px;
	position:absolute;
	top:3px;
...
</script><body><div class="notification attention png_bg" id="notification"><a href="#" class="close"><img src="__IMAGE__/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a><div> 你好！这是你第<?php echo ($_SESSION['login_times']); ?>次登录！ <a href="#" title="Edit your profile" style="font-family:Arial, Helvetica, sans-serif; color:green; font-size:12px;"><?php echo ($_SESSION['admin_username']); ?></a>, 你有 <a href="#messages" rel="modal" title="3 Messages" style="font-family:Arial, Helvetica, sans-serif; color:green; font-size:12px;">3 封邮件</a>  &nbsp;&nbsp;<a href="#dfj" onclick="login_exit()" style="font-family:Arial, Helvetica, sans-serif; color:green; font-size:12px;">【注销】</a><br /></div></div><div class="QQbox" id="divQQbox" style="width:20px; height:60px; cursor:pointer;" title="显示左侧栏！"><img src="__IMAGE__/show_left.png" /></div><img id="amplify" src="__IMAGE__/back_alt.png"/><table><tr><td><div id="middleframe"><ul class="shortcut-buttons-set"><li><a class="shortcut-button" href="__APP__/Test/index"><span><img src="__IMAGE__/icons/computer_process.png" alt="icon" /><br />        系统设置 </span></a></li><li><a class="shortcut-button" href="__APP__/Index/admin_right/"><span><img src="__IMAGE__/icons/goods_add.png" alt="icon" /><br />        商品上传 </span></a></li><li><a class="shortcut-button" href="__APP__/Orderadmin/index/"><span><img src="__IMAGE__/icons/order_admin.png" alt="icon" /><br />        订单管理 </span></a></li><li><a class="shortcut-button" href="__APP__/Useradmin/index/"><span><img src="__IMAGE__/icons/users_edit.png" alt="icon" /><br />        用户管理 </span></a></li><li><a class="shortcut-button" href="__APP__/File/output_goods/"><span><img src="__IMAGE__/icons/database_lock.png" alt="icon" /><br />        商品管理 </span></a></li><!-- <li style="width:280px; overflow:hidden;"><iframe src="http://www.thinkpage.cn/weather/weather.aspx?uid=&cid=101010100&l=zh-CHS&p=CMA&a=1&u=C&s=31&m=0&x=1&d=0&fc=&bgc=&bc=&ti=1&in=1&li=2&ct=iframe" frameborder="0" scrolling="no" width="300" height="80" allowTransparency="true"></iframe></li>--></ul></div></td></tr></table><div id="messages" style="display: none"><!-- Messages are shown when a link with these attributes are clicked: href="#messages" rel="modal"  --><h3>3 Messages</h3><p><strong>17th May 2009</strong> by Admin<br />    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus magna. Cras in mi at felis aliquet congue. <small><a href="#" class="remove-link" title="Remove message">Remove</a></small></p><p><strong>2nd May 2009</strong> by Jane Doe<br />    Ut a est eget ligula molestie gravida. Curabitur massa. Donec eleifend, libero at sagittis mollis, tellus est malesuada tellus, at luctus turpis elit sit amet quam. Vivamus pretium ornare est. <small><a href="#" class="remove-link" title="Remove message">Remove</a></small></p><p><strong>25th April 2009</strong> by Admin<br />    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus magna. Cras in mi at felis aliquet congue. <small><a href="#" class="remove-link" title="Remove message">Remove</a></small></p><form action="#" method="post"><h4>New Message</h4><fieldset><textarea class="textarea" name="textfield" cols="79" rows="5"></textarea></fieldset><fieldset><select name="dropdown" class="small-input"><option value="option1">Send to...</option><option value="option2">Everyone</option><option value="option3">Admin</option><option value="option4">Jane Doe</option></select><input class="button" type="submit" value="Send" /></fieldset></form></div><!--<div id="right">--><div class="content-box"><!-- Start Content Box --><div class="content-box-header" style="position:relative;"><h3>商品信息管理 >> 商品查看/管理</h3><div class="searchbox"><form enctype="multipart/form-data" action="__APP__/File/Output_goods"  method="POST"><input type="text" id="birds" name="search" class="stext" value=""><input class="btnimg" type="submit" value="" /></form></div><div class="clear"></div></div><!-- End .content-box-header --><div class="content-box-content"><?php if($info != null): ?><div id="page_list"><div align="center" id="page"><?php echo ($page); ?></div></div><?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><DIV id="featureContainer"><DIV id="feature"><DIV id="block"><DIV id="botton-scroll"><UL class="featureUL"><?php if(is_array($data['goods_pic'])): foreach($data['goods_pic'] as $key=>$vo): ?><LI class="featureBox"><DIV class="box"><A href="#images<?php echo ($key); ?>" rel="modal" class="modal_images"><IMG src="__UPLOAD__/s_<?php echo ($vo); ?>" width='260' height='165'/></A></DIV><div id="images<?php echo ($key); ?>" style="display: none"><IMG src="__UPLOAD__/<?php echo ($vo); ?>"</div></LI><?php endforeach; endif; ?></UL></DIV></DIV><A class="prev" href="javascript:void();">Previous</A><A class="next" href="javascript:void();">Next</A></DIV></DIV><DIV id="wrap"><SPAN id="load">LOADING...</SPAN></DIV><table cellspacing="0" cellpadding="0" id="goods_table" frame="void" ><!-- <thead><th><p><?php echo ($data['goods_desc']); ?></p></th></thead>--><tr><td id="goods_para"><h3 style="margin-top:9px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;相关信息</h3></td></tr><td><table id="para_table" frame="void"><tr><td class="td_left"><p style="font-size:14px;">产品号码</p></td><td class="td_right"><p style="font-size:14px;"><?php echo ($data['goods_num']); ?></p></td></tr><tr><td class="td_left"><p style="font-size:14px;">产品名称</p></td><td class="td_right"><p style="font-size:14px;"><?php echo ($data['goods_name']); ?></p></td></tr><tr><td class="td_left"><p style="font-size:14px;">产品描述</p></td><td class="td_right"><p style="font-size:14px;"><?php echo ($data['goods_desc']); ?></p></td></tr><tr><td class="td_left"><p style="font-size:14px;">产品类型</p></td><td class="td_right"><p style="font-size:14px;"><?php echo ($data['goods_type']); ?></p></td></tr><tr><td class="td_left"><p style="font-size:14px;">新旧程度</p></td><td class="td_right"><p style="font-size:14px;"><?php echo ($data['goods_new']); ?></p></td></tr><tr><td class="td_left"><p style="font-size:14px;">服务类型</p></td><td class="td_right"><p style="font-size:14px;"><?php echo ($data['goods_service']); ?></p></td></tr><?php if($data['goods_service']=='出售'): ?><tr><td class="td_left"><p style="font-size:14px;">实卖价格</p></td><td class="td_right"><p style="font-size:14px;"><?php echo ($data['sale_price']); ?></p></td></tr><tr><td class="td_left"><p style="font-size:14px;">市场价格</p></td><td class="td_right"><p style="font-size:14px;"><?php echo ($data['market_price']); ?></p></td></tr><?php else: ?><tr><td class="td_left"><p style="font-size:14px;">时租价格</p></td><td class="td_right"><p style="font-size:14px;"><?php echo ($data['hour_price']); ?></p></td></tr><tr><td class="td_left"><p style="font-size:14px;">日租价格</p></td><td class="td_right"><p style="font-size:14px;"><?php echo ($data['day_price']); ?></p></td></tr><tr><td class="td_left"><p style="font-size:14px;">月租价格</p></td><td class="td_right"><p style="font-size:14px;"><?php echo ($data['month_price']); ?></p></td></tr><?php endif; ?><tr><td class="td_left"><p style="font-size:14px;">商品状态</p></td><td class="td_right"><p style="font-size:14px;"><?php echo ($data['goods_state']); ?></p></td></tr><tr><td class="td_left"><p style="font-size:14px;">产品库存</p></td><td class="td_right"><p style="font-size:14px;"><?php echo ($data['goods_inventory']); ?></p></td></tr><tr><td class="td_left"><p style="font-size:14px;">上架时间</p></td><td class="td_right"><p style="font-size:14px;"><?php echo ($data['shelf_time']); ?></p></td></tr></table></td><tr><td id="goods_para"><h3 style="margin-top:9px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;配置参数</h3></td></tr><tr><td><table id="para_table" cellspacing="0" cellpadding="0" frame="void"><?php if(is_array($data['goods_para'])): foreach($data['goods_para'] as $key=>$para): if(!($key%2)): ?><tr><td class="td_left"><p style="font-size:14px;"><?php echo ($para); ?></p></td><?php else: ?><td class="td_right"><p style="font-size:14px;"><?php echo ($para); ?></p></td></tr><?php endif; endforeach; endif; ?></table></td></tr><tr><td id="goods_para"><h3 style="margin-top:9px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;细节描述</h3></td></tr><!-- <tr><td><table id="desc_table" cellspacing="0">--><?php if(is_array($data['desc_pic'])): foreach($data['desc_pic'] as $key=>$pic): ?><tr><td class="desc_td" style="border:none;text-align:center;"><img src="__UPLOAD__/<?php echo ($pic); ?>" / ></td></tr><?php endforeach; endif; ?><!--</table></td></tr>--></table><p><a href="#" style="margin-right:10px;" class="goods_state" title="有货" name="<?php echo ($data['goods_num']); ?>"><img src="__IMAGE__/goods_shelf.png" /></a><a href="#" style="margin-right:10px;"><img src="__IMAGE__/refresh.png" /></a><a href="#"  style="margin-right:10px;" class="goods_state" title="下架" name="<?php echo ($data['goods_num']); ?>"><img src="__IMAGE__/unshelf.png" /></a><a  style="margin-right:10px;" href="#" class="delete_goods" name="<?php echo ($data['goods_num']); ?>"><img src="__IMAGE__/delete.png" /></a></p></DIV></DIV><?php endforeach; endif; else: echo "" ;endif; else: ?>没有符合您条件的商品！<?php endif; ?></div><!-- End .content-box-content --></div><div class="overlay"></div><div id="AjaxLoading" class="showbox"><div class="loadingWord"><img src="__IMAGE__/waiting.gif">正在操作您的请求，请稍候...</div></div><script type="text/javascript">$(function() {
